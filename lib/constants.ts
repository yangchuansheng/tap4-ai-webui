...
export const FORM_PLACEHOLDER = 'https://smartaitools.run/';

export const WEBSITE_EXAMPLE =
  '<a href="https://smartaitools.run/" title="Smart AI Tools Directory">Smart AI Tools Diresctory</a>';
...
export const STARTUP_LIST = [
  ...
  {
    DA: 38,
    Website: 'Smart AI Tools',
    URL: 'https://smartaitools.run/submit',
    Price: 'Free',
    Tag: 'AI',
  },
  {
